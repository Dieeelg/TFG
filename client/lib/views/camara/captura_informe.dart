...
class CapturaInformeScreen extends StatefulWidget {
  ...
  @override
  State<CapturaInformeScreen> createState() => _CapturaInformeScreenState();
}

class _CapturaInformeScreenState extends State<CapturaInformeScreen> {
